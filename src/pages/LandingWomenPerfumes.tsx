...
export default function LandingWomenPerfumes() {
  ...
  return (
    <div className="min-h-screen bg-surface" dir={dir}>
      <SEOHead
        title="أجمل عطور نسائية فاخرة في مصر 2025 — عطور مستوحاة"
        description="اكتشفي أجمل العطور النسائية المستوحاة من Baccarat Rouge 540 و Chanel No. 5 في مصر. عطور فاخرة للعرايس والمناسبات بأسعار تبدأ من 95 ج.م. شحن سريع لجميع المحافظات."
        keywords="عطور نسائية فاخرة مصر, أفضل عطور نسائي 2025, عطور عرايس مصر, عطر باكارا روج مصر, عطور نسائية مستوحاة, عطور شانيل مصر"
        ogUrl="/عطور-نسائية-فاخرة"
