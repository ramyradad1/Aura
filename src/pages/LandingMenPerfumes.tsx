...
const faqItems = [
  ...
  { q: 'هل فيه شحن لجميع محافظات مصر؟', a: 'نعم، نوفر شحن سريع (2-4 أيام عمل) لجميع محافظات مصر مع إمكانية المعاينة عند الاستلام وتأكيد الطلب مباشرة عبر واتساب.' },
];
...
export default function LandingMenPerfumes() {
  ...
  return (
    <div className="min-h-screen bg-surface" dir={dir}>
      <SEOHead
        title="أفضل عطور رجالية فاخرة ومستوحاة في مصر | Aura Perfumes"
        description="تسوق الآن أرقى العطور الرجالية المستوحاة من أشهر الماركات (مثل كريد أفينتوس وتوم فورد). رائحة تدوم طويلاً، جودة عالية وأسعار منافسة في مصر."
        keywords="عطور رجالي مصر, أفضل عطور رجالية 2025, عطور رجالية فاخرة, عطر كريد أفينتوس مصر, عطور مستوحاة رجالي, عطر خشبي رجالي, برفانات رجالي, احسن برفان رجالي, برفان رجالي ثابت وفواح, عطور رجالي تركيب, fragrances, fragrance, scents, scent, luxury fragrances, aura fragrances, برفانات, برفيوز, برفيومز, محاكاه, ريحه, برفان تركيب, برفان, برفيوم, برفيوم محاكاه, دار محاكاه, دور محاكاه, اورا, اورا للبرفانات, اورا برفيوم, اورا برفيومز, هاله"
        ogUrl="/best-men-perfumes"
        canonicalUrl="/عطور-رجالي-مصر"
