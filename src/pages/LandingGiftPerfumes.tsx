...
export default function LandingGiftPerfumes() {
  ...
  return (
    <div className="min-h-screen bg-surface" dir={dir}>
      <SEOHead
        title="أفضل عطور هدايا في مصر 2025 — هدايا عطور فاخرة"
        description="اكتشف أفضل العطور المناسبة كهدايا في مصر. عطور هدايا رجالي، عطور عرايس، وعطور للمناسبات. تغليف فاخر وشحن سريع. أسعار تبدأ من 85 ج.م."
        keywords="عطور هدايا, أفضل عطور هدايا رجالي, عطور عرايس مصر, هدية عطر فاخر, عطور مناسبات, هدايا عيد ميلاد عطور"
        ogUrl="/عطور-هدايا"
