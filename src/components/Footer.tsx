          ...
          <nav aria-label={t('روابط سريعة')}>
            ...
            <ul className="space-y-3">
              {[
                ...
                { to: '/مقارنة-العطور', text: t('مقارنة العطور بالأصلية') },
                { to: '/عطور-رجالي-مصر', text: t('أفضل عطور رجالي') },
                { to: '/عطور-نسائية-فاخرة', text: t('عطور نسائية فاخرة') },
                { to: '/عطور-هدايا', text: t('عطور هدايا') },
